...
/**
 * LoginController handles the login page functionality
 * Includes password visibility toggle and account authentication logic
 */
public class LoginController {
    ...
    /** SQL statement for verifying login credentials against database */
